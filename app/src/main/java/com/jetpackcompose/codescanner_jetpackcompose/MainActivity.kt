package com.jetpackcompose.codescanner_jetpackcompose
...
import com.jetpackcompose.codescanner_jetpackcompose.ui.theme.CodeScannerJetpackComposeTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CodeScannerJetpackComposeTheme() {
                Column(
